  ...
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        className={cn(
          "flex flex-1 items-center justify-between gap-4 py-5 text-left text-sm font-medium text-text outline-none transition-colors hover:text-primary [&[data-state=open]>svg]:rotate-180",
          className
        )}
        {...props}
      >
