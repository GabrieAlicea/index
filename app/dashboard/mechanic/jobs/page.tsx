  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-text-muted">Pending offers, active jobs, and history.</p>
      </div>
      ...
      {jobs && jobs.length > 0 ? (
        ...
        <EmptyState
          icon={Wrench}
          title="No jobs yet"
          body="Go online from your dashboard to start receiving nearby job offers."
